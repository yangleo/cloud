...
from openstack_dashboard.dashboards.project.instances import fastlaunch
...
urlpatterns = patterns(
    ...
    url(r'^image_list$', fastlaunch.getImages, name='instance_image_list'),
    url(r'^network_list$', fastlaunch.getNetworks, name='instance_network_list'),
    url(r'^flavor_create$',fastlaunch.instance_flavor_create,name="instance_flavor_create"),
    url(r'^create$',fastlaunch.instance_create,name="instance_create"),
    url(r'^(?P<instance_id>[^/]+)/$',
